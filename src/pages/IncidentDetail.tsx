...
import { getIncident, getEmployees, updateIncident } from '../api';
...
import { Incident, Employee, getIncidentTypeDisplayName, getIncidentTypeStatusIcon, getIncidentStatusDisplayName, getIncidentStatusColor, getIncidentStatusIcon } from '../models';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [incidentData, employeesData] = await Promise.all([
